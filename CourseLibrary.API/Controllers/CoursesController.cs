...
namespace CourseLibrary.API.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        {
            //dont have to check for matching course and author ids because the courseforupdatedto doesnt have those values, and they are also passed in through the uri
            //we do need to check if they exist however 
            ...
            if (courseForAuthorFromRepo == null)
            {
                //return NotFound(); //remove NotFound() so a new resource will be created if one is not already found
