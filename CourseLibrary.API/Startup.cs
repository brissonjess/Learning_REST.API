            ...
            services.AddControllers(setupAction =>
            {
                ...
                .ConfigureApiBehaviorOptions(setupAction =>
                {
                    setupAction.InvalidModelStateResponseFactory = context =>
                    {
                        ...
                        //found out which status code to use 
                        var actionExecutingContext = context as Microsoft.AspNetCore.Mvc.Filters.ActionExecutingContext;

                        //if there are modelstate errors & all arguments were correctly
                        // found/parsed we'redeailing with validation errors 
                        ...
                        problemDetails.Title = "One or more errors on unput occured.";
            ...
            else
            {
                app.UseExceptionHandler(appBuilder =>
                {
                    appBuilder.Run(async context =>
                    {
                        ...
                        ///best practice would be to log the fault message to a db or a file once you get to this point. not covered in the course just yet
                    });
                });
            }
            app.UseRouting();
